...
fazy = load("fazy.mat");
fazy = fazy.fazy;
% fazy1 = 2* pi * rand( 6 , 100 );
% fazy2 = 2* pi * rand( 6 , 1000 );
psin = A*sin(pi*t*0.1 + fazy(1)) + A*sin(pi*t*0.2+ fazy(2)) + A*sin(pi*t*0.3+ fazy(3)) + A*sin(pi*t*0.4+ fazy(4)) + A*sin(pi*t*0.5+ fazy(5)) + A*sin(pi*t*0.6+ fazy(6));
psin1000 = A*sin(pi*t2*0.1 + fazy(1)) + A*sin(pi*t2*0.2+ fazy(2)) + A*sin(pi*t2*0.3+ fazy(3)) + A*sin(pi*t2*0.4+ fazy(4)) + A*sin(pi*t2*0.5+ fazy(5)) + A*sin(pi*t2*0.6+ fazy(6));
%% Zad2
A = [ 1 -0.5 -0.7 0.5]; 
B = [ 0 0 0.7 0.3];
...
Ruu_matrix = toeplitz(Ruu(length(p1000):length(p1000)+N-1));
Ryu_vector = Ryu(length(p1000):length(p1000)+N-1)';
...
Ruu_matrix = toeplitz(Ruu(length(psin):length(psin)+N-1));
Ryu_vector = Ryu(length(psin):length(psin)+N-1)';
...
[Ryu, ~] = xcorr(wsin1000, psin1000, 'unbiased');
[Ruu, ~] = xcorr(psin1000, psin1000, 'unbiased');
Ruu_matrix = toeplitz(Ruu(length(psin1000):length(psin1000)+N-1));
Ryu_vector = Ryu(length(psin1000):length(psin1000)+N-1)';
